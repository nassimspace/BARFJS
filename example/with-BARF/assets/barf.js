...
const supportedPassiveTypes = ['scroll', 'wheel', "animationstart", "animationend", "transitionend", "click", "resize", "loadedmetadata", "loadeddata", "select", 'touchstart', 'touchmove', 'touchenter', 'touchend', 'touchleave', 'mouseout', 'mouseleave', 'mouseup', 'mousedown', 'mousemove', 'mouseenter', 'mousewheel', 'mouseover'];
